  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* =================================================
            THEME TOGGLE
            Compact icon-only switch — no text, no menu.
        ================================================= */}
        ...
        >
          ...
          >
            {isDark ? (
              <Moon className="h-3 w-3 text-ink-700" strokeWidth={2.2} />
            ) : (
              <Sun className="h-3 w-3 text-brand-500" strokeWidth={2.2} />
            )}
          </span>
        </button>
